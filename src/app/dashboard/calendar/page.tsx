        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="text-right">
              <p className="text-sm font-medium text-charcoal-950">Today's Appointments</p>
              <p className="text-xs text-gold-600">{appointments.filter(a => a.date === selectedDate).length} scheduled</p>
            </div>
          </div>
        </div>
      </motion.div>
